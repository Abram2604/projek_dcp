...
return new class extends Migration
{
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS `sp_keuangan_pengeluaran_list`");

        DB::unprepared("
CREATE PROCEDURE `sp_keuangan_pengeluaran_list` (IN `p_bulan` TINYINT, IN `p_tahun` SMALLINT)
BEGIN
    SELECT
        tp.id,
